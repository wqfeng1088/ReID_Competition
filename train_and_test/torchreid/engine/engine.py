...
class Engine(object):
    ...
    def _evaluate(self, epoch, queryloader=None, galleryloader=None, testdataset=None,
        ...
        for lambda_value in [0.3,0.4,0.5,0.6,0.7,0.8,0.9]:
            for k2 in [6, 5, 4, 3, 2, 1]:
                for k1 in range(1, 21):
                    print("******************************************")
                    print("k1={}, k2={}, lambda={}".format(k1, k2, lambda_value))
                    distmat_rerank, distmat_qq_rerank, distmat_gg_rerank= distmat, distmat_qq, distmat_gg
                    print('Applying person re-ranking ...')
                    distmat_rerank = re_ranking(distmat_rerank, distmat_qq_rerank, distmat_gg_rerank, k1=k1, k2=k2, lambda_value=lambda_value)
        ...
        if rerank:
            ...
            distmat_qq = metrics.compute_distance_matrix(qf, qf, dist_metric)
            distmat_gg = metrics.compute_distance_matrix(gf, gf, dist_metric)
            distmat = re_ranking(distmat, distmat_qq, distmat_gg, k1=6, k2=2, lambda_value=0.9)  # 10, 2, 0.7   8, 4, 0.9
