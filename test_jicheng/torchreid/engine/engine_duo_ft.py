...
class Engine(object):
    ...
    def __init__(self, datamanager, model_1,model_2,model_3,model_4,model_5,model_6,optimizer=None, scheduler=None, use_gpu=True):
    ...
    def test(self, epoch, valloader, testloader, testdataset, dist_metric='euclidean', normalize_feature=False,
        ...
        qf_1_bd, gf_1_bd, q_pids_bd, g_pids_bd=self._evaluate(
            epoch,
            ...
            return_ft=True,
            return_json=False,
            model_1=True, model_2=False, model_3=False, model_4=False, model_5=False,model_6=False
        )
        print('finish: 1_bd')
        qf_2_bd, gf_2_bd, _bd, _bd=self._evaluate(
            epoch,
            queryloader=valqueryloader,
            galleryloader=valgalleryloader,
            testdataset=None,
            ...
            return_ft=True,
            return_json=False,
            model_1=False, model_2=True, model_3=False, model_4=False, model_5=False,model_6=False
        )
        print('finish: 2_bd')
        qf_3_bd, gf_3_bd, _bd, _bd=self._evaluate(
            epoch,
            queryloader=valqueryloader,
            galleryloader=valgalleryloader,
            testdataset=None,
            ...
            return_ft=True,
            return_json=False,
            model_1=False, model_2=False, model_3=True, model_4=False, model_5=False,model_6=False
        )
        print('finish: 3_bd')
        qf_4_bd, gf_4_bd, _bd, _bd=self._evaluate(
            epoch,
            queryloader=valqueryloader,
            galleryloader=valgalleryloader,
            testdataset=None,
            ...
            return_ft=True,
            return_json=False,
            model_1=False, model_2=False, model_3=False, model_4=True, model_5=False,model_6=False
        )
        print('finish: 4_bd')
        qf_5_bd, gf_5_bd, _bd, _bd=self._evaluate(
            epoch,
            queryloader=valqueryloader,
            galleryloader=valgalleryloader,
            testdataset=None,
            ...
            return_ft=True,
            return_json=False,
            model_1=False, model_2=False, model_3=False, model_4=False, model_5=True,model_6=False
        )
        print('finish: 5_bd')
        qf_6_bd, gf_6_bd, _bd, _bd=self._evaluate(
            epoch,
            queryloader=valqueryloader,
            galleryloader=valgalleryloader,
            testdataset=None,
            ...
            return_ft=True,
            return_json=False,
            model_1=False, model_2=False, model_3=False, model_4=False, model_5=False,model_6=True
        )
        print('finish: 6_bd')

        rank1 = self.evaluate_last(
            qf_1_bd, gf_1_bd,qf_2_bd, gf_2_bd,qf_3_bd, gf_3_bd,qf_4_bd, gf_4_bd,qf_5_bd, gf_5_bd,qf_6_bd, gf_6_bd, q_pids_bd, g_pids_bd,
            epoch,
            queryloader=valqueryloader,
            galleryloader=valgalleryloader,
            testdataset=None,
        ...
        if testloader is not None:
            ...
            qf_1, gf_1, q_pids, g_pids=self._evaluate(
                epoch,
            ...
            self.evaluate_last(
                qf_1, gf_1,qf_2, gf_2, qf_3, gf_3,qf_4, gf_4,qf_5, gf_5,qf_6, gf_6, q_pids, g_pids,
                epoch,
                queryloader=queryloader,
                galleryloader=galleryloader,
                testdataset=testdataset,
    ...
    def _evaluate(self, epoch, queryloader=None, galleryloader=None, testdataset=None,
        ...
        if model_1:
            feature_test = self._extract_features_1(imgs)
        elif model_2:
            ...
            feature_test = self._extract_features_6(imgs)
            ...
            for index in range(2):
                ...
                for scale in ms:
                    ...
                    if model_1:
                        ...
                        features_ = self._extract_features_6(imgs)
    ...
    #@torch.no_grad()
    def evaluate_last(self,qf_1, gf_1,qf_2, gf_2, qf_3, gf_3,qf_4, gf_4,qf_5, gf_5,qf_6, gf_6, q_pids, g_pids, epoch, queryloader=None, galleryloader=None, testdataset=None,
                  dist_metric='euclidean', normalize_feature=False, save_dir='', use_metric_cuhk03=False,
                  ranks=[1, 5, 10, 20],
                  rerank=False, multi_scale_interpolate_mode='bilinear', multi_scale=(1,),
        ...
        #print('ft pinjun 6')
        #qf = (qf_1+qf_2+qf_3+qf_4+qf_5+qf_6)*(1.0/6)
        #gf = (gf_1+gf_2+gf_3+gf_4+gf_5+gf_6)*(1.0/6)


        print('feature cat 6')
        qf = torch.cat((qf_1,qf_2,qf_3,qf_4,qf_5,qf_6),1)
        gf = torch.cat((gf_1,gf_2,gf_3,gf_4,gf_5,gf_6),1)
