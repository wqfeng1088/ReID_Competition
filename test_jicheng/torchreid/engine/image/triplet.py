...
class ImageTripletEngine(engine_duo1.Engine):
    ...
    def __init__(self, datamanager, model_1,model_2,model_3,model_4,model_5,model_6, optimizer, num_classes, margin=0.7, #0.3
        ...
        super(ImageTripletEngine, self).__init__(datamanager, model_1,model_2,model_3,model_4,model_5,model_6,optimizer, scheduler)
