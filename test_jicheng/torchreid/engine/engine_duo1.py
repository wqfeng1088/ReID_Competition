...
class Engine(object):
    ...
    def test(self, epoch, valloader, testloader, testdataset, dist_metric='euclidean', normalize_feature=False,
        ...
        print('finish: 5_bd')
        distmat_6_bd, _bd, _bd=self._evaluate(
            epoch,
            queryloader=valqueryloader,
            galleryloader=valgalleryloader,
            testdataset=None,
        ...
        rank1 = self.evaluate_last(
            distmat_1_bd,distmat_2_bd,distmat_3_bd,distmat_4_bd,distmat_5_bd,distmat_6_bd, q_pids_bd, g_pids_bd,
            epoch,
            queryloader=valqueryloader,
            galleryloader=valgalleryloader,
            testdataset=None,
        ...
        if testloader is not None:
            ...
            self.evaluate_last(
                distmat_1,distmat_2,distmat_3,distmat_4,distmat_5,distmat_6, q_pids, g_pids,
                epoch,
                queryloader=queryloader,
                galleryloader=galleryloader,
                testdataset=testdataset,
    ...
    def _evaluate(self, epoch, queryloader=None, galleryloader=None, testdataset=None,
                  ...
                  return_json=False ,
                  return_jl=False,
                  model_1=False,model_2=False,model_3=False,model_4=False,model_5=False,model_6=False
    ...
    # @torch.no_grad()
    def evaluate_last(self,d_1, d_2, d_3, d_4, d_5,d_6, q, g, epoch, queryloader=None, galleryloader=None, testdataset=None,
                  dist_metric='euclidean', normalize_feature=False, save_dir='', use_metric_cuhk03=False,
                  ranks=[1, 5, 10, 20],
                  rerank=False, multi_scale_interpolate_mode='bilinear', multi_scale=(1,),
        ...
        print('ju li 6:')
        distmat_1, distmat_2, distmat_3, distmat_4, distmat_5,distmat_6, q_pids, g_pids = d_1, d_2, d_3, d_4, d_5,d_6, q, g


        distmat = (distmat_1+distmat_2+distmat_3+distmat_4+distmat_5+distmat_6)*(1.0/6)
