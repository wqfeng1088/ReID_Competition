...
class ImageTripletEngine(engine.Engine):
    ...
    def __init__(self, datamanager, model, optimizer, num_classes, margin=0.3,
                 ...
                 label_smooth=True, use_oim=False, weight_o=1, use_center=False, center_lr=0.5, weight_c=0.0005, oim_dims=512, center_dims=2048, use_ranked_loss=False, weight_r=1, use_focal=False, weight_f=1, epsilon=0.1):
        ...
        for batch_idx, data in enumerate(trainloader):
            ...
            if (batch_idx+1) % print_freq == 0:
                ...
                """print('Epoch: [{}/{}][{}/{}]\t'
                      ...
                      'Acc {:.2f} ({:.2f})\t'.format(
                      epoch+1, max_epoch, batch_idx+1, num_batches,
                      loss_vis[0], loss_vis[1], loss_vis[2], loss_vis[3], loss_vis[4], loss_vis[5], loss_vis[6], loss_vis[7], loss_vis[8], loss_vis[9],
                      accs.val, accs.avg,
                    )
                )"""
